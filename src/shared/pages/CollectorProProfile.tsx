"use client"
import { useParams } from "@/shared/use/navigate"
          ...
          <div className="relative z-10 p-8 md:p-12">
              ...
              <motion.div initial={{ x: 50, opacity: 0 }} animate={{ x: 0, opacity: 1 }} className="space-y-4">
                ...
                <div className="flex flex-wrap gap-4">
                  <div className="bg-yellow-900/50 px-4 py-2 rounded-lg flex items-center gap-2">
                    ...
                    <span>{t("collectorPro.globalRank", { rank: profile.rank.global })}</span>
                  </div>
                  <div className="bg-yellow-900/50 px-4 py-2 rounded-lg flex items-center gap-2">
                    <Medal className="w-5 h-5 text-yellow-400" />
                    <span>
                      {t("collectorPro.categoryRank", {
                        rank: profile.rank.categoryRank,
            ...
            >
              <div className="bg-yellow-900/30 p-6 rounded-lg text-center">
                ...
                <p className="text-yellow-100">{t("collectorPro.completedCollections")}</p>
              </div>
              <div className="bg-yellow-900/30 p-6 rounded-lg text-center">
                <Swords className="w-12 h-12 text-yellow-400 mx-auto mb-4" />
                <h3 className="text-2xl font-bold mb-2">{profile.stats.exchanges}</h3>
                <p className="text-yellow-100">{t("collectorPro.successfulExchanges")}</p>
              </div>
              <div className="bg-yellow-900/30 p-6 rounded-lg text-center">
                ...
                <p className="text-yellow-100">{t("collectorPro.reputation")}</p>
              </div>
            </motion.div>
            ...
            <div className="mt-12 grid md:grid-cols-2 gap-8">
              ...
              >
                <h3 className="text-xl font-bold mb-4 text-yellow-300">{t("collectorPro.featuredAchievements")}</h3>
              ...
              <motion.div
                ...
                className="bg-yellow-900/30 p-6 rounded-lg"
              >
                <h3 className="text-xl font-bold mb-4 text-yellow-300">{t("collectorPro.statistics")}</h3>
                <div className="space-y-4">
                  <div className="flex justify-between">
                    <span className="text-yellow-100">{t("collectorPro.totalCards")}</span>
                    <span className="text-yellow-300">{profile.stats.totalCards}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-yellow-100">{t("collectorPro.completedCollections")}</span>
                    <span className="text-yellow-300">{profile.stats.completedCollections}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-yellow-100">{t("collectorPro.successRate")}</span>
            ...
            <div className="mt-12 text-center">
              <Button size="lg" className="bg-yellow-600 hover:bg-yellow-700 text-white font-playfair">
                {t("collectorPro.challengeToDuel")}
              </Button>
            </div>
          </div>
        </div>
