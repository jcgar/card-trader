...
import type { Collection, Rarity } from "@/app/types"
...
export default function FeaturedCollectionsCard({ collection, type }: FeaturedCollectionsCardProps) {
    ...
    <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
      <Card className="overflow-hidden transition-all duration-500">
        <div className="p-6">
          ...
          <h3 className="text-xl font-bold text-center mb-2">{collection.name}</h3>
